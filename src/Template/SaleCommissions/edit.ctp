...
/* File: src/Template/Pages/SaleCommissions/edit.ctp */
...
?>
    ...
    <div class="container-fluid">
        <div class="row">
            <?= $this->Form->control('id', ['label' => false, 'hidden' => true, 'value' => 1234]) ?>
        ...
        <div class="top-10 row">
            <div class="col-xs-12 col-sm-6">
                ...
                <?= $this->Form->control('from_plans_id', ['label' => false, 'class' => $input, 'options' => ['opção 1', 'opção 2', 'opção 3', 'opção 4'], 'empty' => __('Escolha uma opção')]) ?>
            </div>
            <div class="col-xs-12 col-sm-6">
                <label class="<?= $label ?>">
                ...
                <?= $this->Form->control('to_plans_id', ['label' => false, 'class' => $input, 'options' => ['opção 1', 'opção 2', 'opção 3', 'opção 4'], 'empty' => __('Escolha uma opção')]) ?>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div class="input-group">
                            ...
                            <?= $this->Form->input('value', ['label' => false, 'class' => 'form-control valuemask', 'type' => 'text', 'value' => $this->Number->precision(1234.56, 2), 'required' => true]); ?>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <label class="<?= $label ?>">
                        ...
                        <?= $this->Form->control('type', ['label' => false, 'class' => $input, 'options' => ['ID' => __('Indicação Direta'), 
