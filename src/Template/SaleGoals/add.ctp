                ...
                <div class="col-xs-12 well">
                    <div class="row">
                        ...
                        <div class="<?= $double ?>">
                            ...
                            <?= $this->Form->control('benefit_products_id', ['label' => false, 'class' => $input, 'options' => ['opção 1', 'opção 2', 'opção 3', 'opção 4']]) ?>
                        </div>
                        <div class="<?= $double ?>">
                            <label class="<?= $label ?>">
                            ...
                            <?= $this->Form->control('howmuch', ['label' => false, 'type' => 'number', 'pattern' => "[0-9]", 'onkeyup' => "this.value=this.value.replace(/[^0-9]/g,'');", 'class' => 'form-control form-group', 'placeholder' => 'Ex: 100']) ?>
                        </div>
                    </div>
                </div>
            </div>
