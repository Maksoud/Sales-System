...
/* File: src/Template/Pages/GoalPlans/edit.ctp */
                ...
                <div class="row">
                    <div class="<?= $double ?>">
                        ...
                        <div class="input-group">
                            ...
                            <?= $this->Form->control('fee', ['label' => false, 'type' => 'text', 'class' => 'form-control valuemask', 'value' => $this->Number->precision(1234.56, 2), 'required' => true]) ?>
                        </div>
                    </div>
                    ...
                    <div class="<?= $double ?>">
                        ...
                        <?= $this->Form->control('saleGoals', ['label' => false, 'type' => 'number', 'pattern' => "[0-9]", 'onkeyup' => "this.value=this.value.replace(/[^0-9]/g,'');", 'class' => 'form-control form-group', 'placeholder' => 'Ex: 100']) ?>
                    </div>
                </div>
            </div>
